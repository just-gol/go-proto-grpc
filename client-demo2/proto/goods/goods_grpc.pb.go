...
// GoodsClient is the client API for Goods server-micro-demo1.
//
...
func (c *goodsClient) GetGoods(ctx context.Context, in *GetGoodsReq, opts ...grpc.CallOption) (*GetGoodsRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetGoodsRes)
	err := c.cc.Invoke(ctx, Goods_GetGoods_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// GoodsServer is the server API for Goods server-micro-demo1.
...
// UnsafeGoodsServer may be embedded to opt out of forward compatibility for this server-micro-demo1.
...
// Goods_ServiceDesc is the grpc.ServiceDesc for Goods server-micro-demo1.
