...
type Order struct {
	...
	Item          *OrderItem             `protobuf:"bytes,7,opt,name=item,proto3" json:"item,omitempty"`
...
const file_order_proto_rawDesc = "" +
	...
	"\aaddTime\x18\x06 \x01(\tR\aaddTime\x12\x1e\n" +
	"\x04item\x18\a \x01(\v2\n" +
	".OrderItemR\x04item\"c\n" +
	"\tOrderItem\x12\x18\n" +
...
var file_order_proto_depIdxs = []int32{
	1, // 0: Order.item:type_name -> OrderItem
